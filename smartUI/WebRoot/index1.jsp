...
<html>
  <head>
  	<script type="text/javascript" src="<%=path %>/smartUI/jquery/jquery-1.9.0.js"></script>
    <script type="text/javascript" src="<%=path %>/smartUI/smart/smart.debug-6.0.js"></script>
  </head>
  <body>
  	<table id="tree"></table>
    <div id="pager"></div>
